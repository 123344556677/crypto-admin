import { getInformationCounts } from "Api/Api";
          ...
          <Col lg="4" md="6" sm="6">
            <Card className="card-stats">
                ...
                <Row>
                  ...
                  <Col md="8" xs="7">
                    <div className="numbers">
                      <p className="card-category">Total Active Users</p>
                      <CardTitle tag="p">{info?.TotalUsers}</CardTitle>
                      <p />
                    </div>
                  </Col>
                </Row>
              ...
              <CardFooter>
                <hr />
                <div className="stats">
                  <i className="far fa-calendar" /> Since Begining
                </div>
              </CardFooter>
            </Card>
          </Col>
            ...
            <Card className="card-stats">
              <CardBody>
                <Row>
                  ...
                  <Col md="8" xs="7">
                    <div className="numbers">
                      <p className="card-category">Users Deposited Cash</p>
                      <CardTitle tag="p">{info?.getCashDeposited}</CardTitle>
                      <p />
                    </div>
                  </Col>
                </Row>
